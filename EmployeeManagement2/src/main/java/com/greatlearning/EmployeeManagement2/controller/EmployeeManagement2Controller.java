package com.greatlearning.EmployeeManagement2.controller;
...
import com.greatlearning.EmployeeManagement2.service.EmployeeService;

@RestController
@RequestMapping("/api")
public class EmployeeManagement2Controller {
	@Autowired
